...
export default function Appointment() {
  ...
  return (
    <div id="requestaquickquote" className="mb-10 w-full">
      <ToastContainer />
      <h1 className="flex justify-center font-bold md:text-[40px] text-[20px] mt-10 font-[monospace] uppercase">
        Request a quick quote
      </h1>
      <form
        className="max-w-md mx-auto mt-10 px-10 md:px-0"
