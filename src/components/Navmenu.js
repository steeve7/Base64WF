...
const menus = [
  ...
  { id: "#requestaquickquote", label: "Request a quick quote" },
];
  ...
  return (
    ...
    >
      <div className="flex justify-between md:py-7 py-4 md:px-20 px-7 bg-white">
        ...
        <div className="justify-center gap-6 items-center lg:flex flex-row hidden text-black uppercase font-normal">
          {menus.map((menu, i) => (
            <div key={i}>
              ...
              <div className="">
                {menus.map((menu, i) => (
                  <p key={i} className="text-white font_family py-[1rem] px-0">
                    <a href={menu.id} onClick={() => setMenuSlide(false)}>
                      {menu.label}
                    </a>
                  </p>
                ))}
